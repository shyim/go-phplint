...
func TestNewTokenPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewTokenPosition(tkn)
...
func TestNewTokensPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewTokensPosition(token1, token2)
...
func TestNewNodePosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodePosition(n)
...
func TestNewTokenNodePosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewTokenNodePosition(tkn, n)
...
func TestNewNodeTokenPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeTokenPosition(n, tkn)
...
func TestNewNodeListPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeListPosition([]ast.Vertex{n1, n2})
...
func TestNewNodesPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodesPosition(n1, n2)
...
func TestNewNodeListTokenPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeListTokenPosition([]ast.Vertex{n1, n2}, tkn)
...
func TestNewTokenNodeListPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewTokenNodeListPosition(tkn, []ast.Vertex{n1, n2})
...
func TestNewNodeNodeListPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeNodeListPosition(n1, []ast.Vertex{n2, n3})
...
func TestNewNodeListNodePosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeListNodePosition([]ast.Vertex{n1, n2}, n3)
...
func TestNewOptionalListTokensPosition(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewOptionalListTokensPosition(nil, token1, token2)
...
func TestNewOptionalListTokensPosition2(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewOptionalListTokensPosition([]ast.Vertex{n2, n3}, token1, token2)

	assert.DeepEqual(t, &position.Position{StartLine: 2, EndLine: 5, StartPos: 9, EndPos: 32}, pos)
}

func TestNilNodePos(t *testing.T) {
	pos := posbuilder.NewBuilder().NewNodesPosition(nil, nil)
...
func TestNilNodeListPos(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeNodeListPosition(n1, nil)
...
func TestNilNodeListTokenPos(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeListTokenPosition(nil, tkn)
...
func TestEmptyNodeListPos(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeNodeListPosition(n1, []ast.Vertex{})
...
func TestEmptyNodeListTokenPos(t *testing.T) {
	...
	pos := posbuilder.NewBuilder().NewNodeListTokenPosition([]ast.Vertex{}, tkn)
